    ...
    <section class="article-content container pt-2">
      <div class="row">
        <div class="col-xs-12 col-md-4">
          ...
          <div class="col-xs-12 d-none d-md-block mt-5 pt-5">
            <section class="post-archive">
              ...
              <div class="row">
                <post-list class="post-list col mx-auto" :posts="post.relatedPosts"/>
              </div>
              <div class="col-xs-12 py-3 mx-md-auto">
                <nuxt-link to="/" class="btn btn-outline-secondary btn-block">All Posts</nuxt-link>
              </div>
            </section>
          </div>
        </div>
        ...
        <article class="col-xs-12 col-md-8 mt-2 mt-md-0">
          ...
          <!-- <div class="col-md-12 py-5 mt-4 d-none d-md-flex justify-content-between">
            <nuxt-link to="/" class="btn btn-outline-secondary btn-md">&larr; Previous Post</nuxt-link>
            <nuxt-link to="/" class="btn btn-outline-secondary btn-md">Next Post &rarr;</nuxt-link>
          </div> -->
        </article>
      </div>
    </section>
...
export default {
  ...
  head(ctx){
    return {
      ...
      meta: [
      { hid: 'description', name: 'description', content: this.post.subtitle },
      ...
      link: [
      { rel: 'stylesheet', href: '/css/hl.css' },
    ]
    }
  },
  async asyncData(ctx) {
